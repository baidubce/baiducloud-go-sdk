...
type Operator struct {
	...
	ParallelismControl    *ParallelismControl    `json:"parallelismControl,omitempty"`
	...
	AllowedFailureControl *AllowedFailureControl `json:"allowedFailureControl,omitempty"`
