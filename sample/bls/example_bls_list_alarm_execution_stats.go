...
func ListAlarmExecutionStats() {
	...
	listAlarmExecutionStatsRequest := &bls.ListAlarmExecutionStatsRequest{
	...
	result, err := client.ListAlarmExecutionStats(listAlarmExecutionStatsRequest)
	if err != nil {
