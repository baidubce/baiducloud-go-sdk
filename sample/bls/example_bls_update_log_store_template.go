...
func UpdateLogStoreTemplate() {
	...
	updateLogStoreTemplateRequest := &bls.UpdateLogStoreTemplateRequest{
		Name:             util.PtrString(""),
		ProjectPatterns:  []*string{},
		LogstorePatterns: []*string{},
		Priority:         util.PtrInt32(int32(0)),
	...
	result, err := client.UpdateLogStoreTemplate(updateLogStoreTemplateRequest)
	if err != nil {
