...
func DescribeLogStoreTemplates() {
	...
	describeLogStoreTemplatesRequest := &bls.DescribeLogStoreTemplatesRequest{
		Name:     util.PtrString(""),
	...
	result, err := client.DescribeLogStoreTemplates(describeLogStoreTemplatesRequest)
	if err != nil {
