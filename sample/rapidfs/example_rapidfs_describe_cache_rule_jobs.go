...
func DescribeCacheRuleJobs() {
	...
	describeCacheRuleJobsRequest := &rapidfs.DescribeCacheRuleJobsRequest{
	...
	result, err := client.DescribeCacheRuleJobs(describeCacheRuleJobsRequest)
	if err != nil {
