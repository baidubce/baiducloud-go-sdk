...
func DescribeSystemTemplateRules() {
	...
	describeSystemTemplateRulesRequest := &bcm.DescribeSystemTemplateRulesRequest{
		Scope:           util.PtrString(""),
		ResourceType:    util.PtrString(""),
		SubResourceType: util.PtrString(""),
		Source:          util.PtrString(""),
	}
	result, err := client.DescribeSystemTemplateRules(describeSystemTemplateRulesRequest)
	if err != nil {
