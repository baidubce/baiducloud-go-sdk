...
func DescribeNotifyTemplates() {
	...
	describeNotifyTemplatesRequest := &bcm.DescribeNotifyTemplatesRequest{
		Name:     util.PtrString(""),
	...
	result, err := client.DescribeNotifyTemplates(describeNotifyTemplatesRequest)
	if err != nil {
