...
func DescribeAlarmMaskings() {
	...
	describeAlarmMaskingsRequest := &bcm.DescribeAlarmMaskingsRequest{
	...
	result, err := client.DescribeAlarmMaskings(describeAlarmMaskingsRequest)
	if err != nil {
