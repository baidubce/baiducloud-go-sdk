...
func DescribeInstanceGroups() {
	...
	describeInstanceGroupsRequest := &bcm.DescribeInstanceGroupsRequest{
	...
	result, err := client.DescribeInstanceGroups(describeInstanceGroupsRequest)
	if err != nil {
