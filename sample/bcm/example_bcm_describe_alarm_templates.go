...
func DescribeAlarmTemplates() {
	...
	describeAlarmTemplatesRequest := &bcm.DescribeAlarmTemplatesRequest{
		Name:            util.PtrString(""),
	...
	result, err := client.DescribeAlarmTemplates(describeAlarmTemplatesRequest)
	if err != nil {
