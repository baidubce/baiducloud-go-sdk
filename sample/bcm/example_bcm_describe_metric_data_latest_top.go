...
func DescribeMetricDataLatestTop() {
	...
	describeMetricDataLatestTopRequest := &bcm.DescribeMetricDataLatestTopRequest{
	...
	result, err := client.DescribeMetricDataLatestTop(describeMetricDataLatestTopRequest)
	if err != nil {
