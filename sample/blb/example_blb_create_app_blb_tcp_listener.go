...
func CreateAppBlbTcpListener() {
	...
	createAppBlbTcpListenerRequest := &blb.CreateAppBlbTcpListenerRequest{
	...
	err = client.CreateAppBlbTcpListener(createAppBlbTcpListenerRequest)
	if err != nil {
