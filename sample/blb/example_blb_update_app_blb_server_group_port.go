...
func UpdateAppBlbServerGroupPort() {
	...
	updateAppBlbServerGroupPortRequest := &blb.UpdateAppBlbServerGroupPortRequest{
	...
	err = client.UpdateAppBlbServerGroupPort(updateAppBlbServerGroupPortRequest)
	if err != nil {
