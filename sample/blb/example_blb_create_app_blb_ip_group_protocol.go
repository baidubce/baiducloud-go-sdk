...
func CreateAppBlbIpGroupProtocol() {
	...
	createAppBlbIpGroupProtocolRequest := &blb.CreateAppBlbIpGroupProtocolRequest{
	...
	err = client.CreateAppBlbIpGroupProtocol(createAppBlbIpGroupProtocolRequest)
	if err != nil {
