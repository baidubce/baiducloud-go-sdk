...
func CreateAppBlbHttpListener() {
	...
	createAppBlbHttpListenerRequest := &blb.CreateAppBlbHttpListenerRequest{
	...
	err = client.CreateAppBlbHttpListener(createAppBlbHttpListenerRequest)
	if err != nil {
