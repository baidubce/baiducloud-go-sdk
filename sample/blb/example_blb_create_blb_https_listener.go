...
func CreateBlbHttpsListener() {
	...
	createBlbHttpsListenerRequest := &blb.CreateBlbHttpsListenerRequest{
	...
	err = client.CreateBlbHttpsListener(createBlbHttpsListenerRequest)
	if err != nil {
