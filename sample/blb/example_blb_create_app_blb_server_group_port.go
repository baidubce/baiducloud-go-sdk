...
func CreateAppBlbServerGroupPort() {
	...
	createAppBlbServerGroupPortRequest := &blb.CreateAppBlbServerGroupPortRequest{
	...
	result, err := client.CreateAppBlbServerGroupPort(createAppBlbServerGroupPortRequest)
	if err != nil {
