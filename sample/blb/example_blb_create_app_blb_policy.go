...
func CreateAppBlbPolicy() {
	...
	createAppBlbPolicyRequest := &blb.CreateAppBlbPolicyRequest{
		BlbId:        util.PtrString(""),
		ClientToken:  util.PtrString(""),
		ListenerPort: util.PtrInt32(int32(0)),
		AppPolicyVos: []*blb.CreateAppPolicy{},
		BlbType:      util.PtrString(""),
	}
	err = client.CreateAppBlbPolicy(createAppBlbPolicyRequest)
	if err != nil {
