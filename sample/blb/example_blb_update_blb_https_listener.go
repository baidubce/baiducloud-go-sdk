...
func UpdateBlbHttpsListener() {
	...
	updateBlbHttpsListenerRequest := &blb.UpdateBlbHttpsListenerRequest{
	...
	err = client.UpdateBlbHttpsListener(updateBlbHttpsListenerRequest)
	if err != nil {
