...
func UpdateAppBlbTcpListener() {
	...
	updateAppBlbTcpListenerRequest := &blb.UpdateAppBlbTcpListenerRequest{
	...
	err = client.UpdateAppBlbTcpListener(updateAppBlbTcpListenerRequest)
	if err != nil {
