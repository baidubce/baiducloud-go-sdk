...
func UpdateNetworkDetection() {
	...
	updateNetworkDetectionRequest := &vpc.UpdateNetworkDetectionRequest{
	...
	err = client.UpdateNetworkDetection(updateNetworkDetectionRequest)
	if err != nil {
