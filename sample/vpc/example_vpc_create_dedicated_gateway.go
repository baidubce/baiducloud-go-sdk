...
func CreateDedicatedGateway() {
	...
	createDedicatedGatewayRequest := &vpc.CreateDedicatedGatewayRequest{
	...
	result, err := client.CreateDedicatedGateway(createDedicatedGatewayRequest)
	if err != nil {
