...
func CreateNetworkDetection() {
	...
	createNetworkDetectionRequest := &vpc.CreateNetworkDetectionRequest{
	...
	result, err := client.CreateNetworkDetection(createNetworkDetectionRequest)
	if err != nil {
