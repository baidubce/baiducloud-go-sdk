...
func UpdateNatReleaseProtectionSwitch() {
	...
	updateNatReleaseProtectionSwitchRequest := &vpc.UpdateNatReleaseProtectionSwitchRequest{
		NatId:         util.PtrString(""),
		ClientToken:   util.PtrString(""),
		DeleteProtect: util.PtrBool(false),
	}
	err = client.UpdateNatReleaseProtectionSwitch(updateNatReleaseProtectionSwitchRequest)
	if err != nil {
