...
func AuthorizeRegularSecurityGroupRulesV2() {
	...
	authorizeRegularSecurityGroupRulesV2Request := &vpc.AuthorizeRegularSecurityGroupRulesV2Request{
		SecurityGroupId: util.PtrString(""),
		SgVersion:       util.PtrInt64(int64(0)),
		ClientToken:     util.PtrString(""),
		Rule:            Rule,
	}
	err = client.AuthorizeRegularSecurityGroupRulesV2(authorizeRegularSecurityGroupRulesV2Request)
	if err != nil {
