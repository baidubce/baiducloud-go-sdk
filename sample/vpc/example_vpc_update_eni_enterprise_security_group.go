...
func UpdateEniEnterpriseSecurityGroup() {
	...
	updateEniEnterpriseSecurityGroupRequest := &vpc.UpdateEniEnterpriseSecurityGroupRequest{
		EniId:                      util.PtrString(""),
		ClientToken:                util.PtrString(""),
		EnterpriseSecurityGroupIds: []*string{},
	}
	err = client.UpdateEniEnterpriseSecurityGroup(updateEniEnterpriseSecurityGroupRequest)
	if err != nil {
