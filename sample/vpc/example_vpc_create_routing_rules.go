...
func CreateRoutingRules() {
	...
	createRoutingRulesRequest := &vpc.CreateRoutingRulesRequest{
		...
		NextHopList:        []*vpc.NextHop{},
		Description:        util.PtrString(""),
	}
	result, err := client.CreateRoutingRules(createRoutingRulesRequest)
	if err != nil {
