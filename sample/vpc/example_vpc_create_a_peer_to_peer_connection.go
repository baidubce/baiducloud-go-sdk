...
func CreateAPeerToPeerConnection() {
	...
	createAPeerToPeerConnectionRequest := &vpc.CreateAPeerToPeerConnectionRequest{
	...
	result, err := client.CreateAPeerToPeerConnection(createAPeerToPeerConnectionRequest)
	if err != nil {
