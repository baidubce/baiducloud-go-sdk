...
func QuerySecurityGroupsList() {
	...
	querySecurityGroupsListRequest := &vpc.QuerySecurityGroupsListRequest{
	...
	result, err := client.QuerySecurityGroupsList(querySecurityGroupsListRequest)
	if err != nil {
