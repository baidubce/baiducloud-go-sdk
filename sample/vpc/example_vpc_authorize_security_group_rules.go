...
func AuthorizeSecurityGroupRules() {
	...
	authorizeSecurityGroupRulesRequest := &vpc.AuthorizeSecurityGroupRulesRequest{
		SecurityGroupId: util.PtrString(""),
		SgVersion:       util.PtrInt64(int64(0)),
		ClientToken:     util.PtrString(""),
		Rule:            Rule,
	}
	err = client.AuthorizeSecurityGroupRules(authorizeSecurityGroupRulesRequest)
	if err != nil {
