...
func UpdateIpv6GatewaySpeedLimitPolicy() {
	...
	updateIpv6GatewaySpeedLimitPolicyRequest := &vpc.UpdateIpv6GatewaySpeedLimitPolicyRequest{
	...
	err = client.UpdateIpv6GatewaySpeedLimitPolicy(updateIpv6GatewaySpeedLimitPolicyRequest)
	if err != nil {
