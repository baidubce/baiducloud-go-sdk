...
func CreateIpv6GatewaySpeedLimitPolicy() {
	...
	createIpv6GatewaySpeedLimitPolicyRequest := &vpc.CreateIpv6GatewaySpeedLimitPolicyRequest{
	...
	result, err := client.CreateIpv6GatewaySpeedLimitPolicy(createIpv6GatewaySpeedLimitPolicyRequest)
	if err != nil {
