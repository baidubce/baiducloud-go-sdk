...
func UpdateDedicatedChannelBfd() {
	...
	updateDedicatedChannelBfdRequest := &et.UpdateDedicatedChannelBfdRequest{
		EtId:             util.PtrString(""),
	...
	err = client.UpdateDedicatedChannelBfd(updateDedicatedChannelBfdRequest)
	if err != nil {
