...
func CreateDedicatedChannelRouteRules() {
	...
	createDedicatedChannelRouteRulesRequest := &et.CreateDedicatedChannelRouteRulesRequest{
		EtId:        util.PtrString(""),
	...
	result, err := client.CreateDedicatedChannelRouteRules(createDedicatedChannelRouteRulesRequest)
	if err != nil {
