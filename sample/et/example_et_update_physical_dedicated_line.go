...
func UpdatePhysicalDedicatedLine() {
	...
	updatePhysicalDedicatedLineRequest := &et.UpdatePhysicalDedicatedLineRequest{
	...
	err = client.UpdatePhysicalDedicatedLine(updatePhysicalDedicatedLineRequest)
	if err != nil {
