...
func EnableDedicatedChannelIpv6() {
	...
	enableDedicatedChannelIpv6Request := &et.EnableDedicatedChannelIpv6Request{
		EtId:                util.PtrString(""),
	...
	err = client.EnableDedicatedChannelIpv6(enableDedicatedChannelIpv6Request)
	if err != nil {
