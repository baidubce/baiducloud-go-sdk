...
func CreateSandboxSnapshot() {
	...
	createSandboxSnapshotRequest := &ax.CreateSandboxSnapshotRequest{
		SandboxID: util.PtrString(""),
		Name:      util.PtrString(""),
	}
	result, err := client.CreateSandboxSnapshot(createSandboxSnapshotRequest)
	if err != nil {
