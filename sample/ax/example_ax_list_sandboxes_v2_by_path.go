...
func ListSandboxesV2ByPath() {
	...
	listSandboxesV2ByPathRequest := &ax.ListSandboxesV2ByPathRequest{
		Limit:     util.PtrInt32(int32(0)),
		NextToken: util.PtrString(""),
		Metadata:  util.PtrString(""),
		State:     util.PtrString(""),
	}
	result, err := client.ListSandboxesV2ByPath(listSandboxesV2ByPathRequest)
	if err != nil {
