...
func ListProtectInstances() {
	...
	listProtectInstancesRequest := &cfw.ListProtectInstancesRequest{
	...
	result, err := client.ListProtectInstances(listProtectInstancesRequest)
	if err != nil {
