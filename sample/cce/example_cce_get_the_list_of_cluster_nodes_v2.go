...
func GetTheListOfClusterNodesV2() {
	...
	getTheListOfClusterNodesV2Request := &cce.GetTheListOfClusterNodesV2Request{
	...
	result, err := client.GetTheListOfClusterNodesV2(getTheListOfClusterNodesV2Request)
	if err != nil {
