...
func MoveIntoAnExistingNodeV2() {
	...
	moveIntoAnExistingNodeV2Request := &cce.MoveIntoAnExistingNodeV2Request{
		...
		ExistedInstances:                   []*cce.InstanceSet{},
		ExistedInstancesInCluster:          []*cce.ExistedInstanceInCluster{},
	}
	result, err := client.MoveIntoAnExistingNodeV2(moveIntoAnExistingNodeV2Request)
	if err != nil {
