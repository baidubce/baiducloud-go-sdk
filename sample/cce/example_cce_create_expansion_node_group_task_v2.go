...
func CreateExpansionNodeGroupTaskV2() {
	...
	createExpansionNodeGroupTaskV2Request := &cce.CreateExpansionNodeGroupTaskV2Request{
		ClusterID:       util.PtrString(""),
		InstanceGroupID: util.PtrString(""),
		UpToReplicas:    util.PtrInt32(int32(0)),
		UpReplicas:      util.PtrInt32(int32(0)),
	}
	result, err := client.CreateExpansionNodeGroupTaskV2(createExpansionNodeGroupTaskV2Request)
	if err != nil {
