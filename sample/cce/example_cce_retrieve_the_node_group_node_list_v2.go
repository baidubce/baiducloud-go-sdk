...
func RetrieveTheNodeGroupNodeListV2() {
	...
	retrieveTheNodeGroupNodeListV2Request := &cce.RetrieveTheNodeGroupNodeListV2Request{
		ClusterID:       util.PtrString(""),
		InstanceGroupID: util.PtrString(""),
		PageNo:          util.PtrInt32(int32(0)),
		PageSize:        util.PtrInt32(int32(0)),
	}
	result, err := client.RetrieveTheNodeGroupNodeListV2(retrieveTheNodeGroupNodeListV2Request)
	if err != nil {
