...
func CreateDatasetVersionV2() {
	...
	createDatasetVersionV2Request := &aihc.CreateDatasetVersionV2Request{
		DatasetId:   util.PtrString(""),
		Description: util.PtrString(""),
		StoragePath: util.PtrString(""),
		MountPath:   util.PtrString(""),
	}
	result, err := client.CreateDatasetVersionV2(createDatasetVersionV2Request)
	if err != nil {
