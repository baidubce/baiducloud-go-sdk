...
func DescribeModelVersions() {
	...
	describeModelVersionsRequest := &aihc.DescribeModelVersionsRequest{
		ModelId:    util.PtrString(""),
		PageNumber: util.PtrInt32(int32(0)),
		PageSize:   util.PtrInt32(int32(0)),
	}
	result, err := client.DescribeModelVersions(describeModelVersionsRequest)
	if err != nil {
