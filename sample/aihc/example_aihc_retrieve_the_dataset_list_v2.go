...
func RetrieveTheDatasetListV2() {
	...
	retrieveTheDatasetListV2Request := &aihc.RetrieveTheDatasetListV2Request{
	...
	result, err := client.RetrieveTheDatasetListV2(retrieveTheDatasetListV2Request)
	if err != nil {
