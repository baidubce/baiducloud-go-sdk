...
func BatchStopTrainingTasksV2() {
	...
	batchStopTrainingTasksV2Request := &aihc.BatchStopTrainingTasksV2Request{
		QueueID:        util.PtrString(""),
		ResourcePoolId: util.PtrString(""),
		JobList:        []*map[string]interface{}{},
		JobListJobId:   util.PtrString(""),
	}
	result, err := client.BatchStopTrainingTasksV2(batchStopTrainingTasksV2Request)
	if err != nil {
