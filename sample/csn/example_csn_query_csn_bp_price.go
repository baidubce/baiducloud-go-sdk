...
func QueryCsnBpPrice() {
	...
	Billing := &csn.Billing{
		...
		Reservation: &csn.Reservation{
			ReservationLength:   util.PtrInt32(int32(0)),
			ReservationTimeUnit: util.PtrString(""),
		},
	}
	queryCsnBpPriceRequest := &csn.QueryCsnBpPriceRequest{
		Name:        util.PtrString(""),
	...
	result, err := client.QueryCsnBpPrice(queryCsnBpPriceRequest)
	if err != nil {
