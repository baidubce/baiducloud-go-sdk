...
func ModifyTbspIpCleanThreshold() {
	...
	modifyTbspIpCleanThresholdRequest := &eip.ModifyTbspIpCleanThresholdRequest{
		Id:            util.PtrString(""),
	...
	err = client.ModifyTbspIpCleanThreshold(modifyTbspIpCleanThresholdRequest)
	if err != nil {
