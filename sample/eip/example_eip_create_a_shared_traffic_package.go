...
func CreateASharedTrafficPackage() {
	...
	createASharedTrafficPackageRequest := &eip.CreateASharedTrafficPackageRequest{
	...
	result, err := client.CreateASharedTrafficPackage(createASharedTrafficPackageRequest)
	if err != nil {
