...
func PurchaseReservedEipGroup() {
	...
	purchaseReservedEipGroupRequest := &eip.PurchaseReservedEipGroupRequest{
		Id:          util.PtrString(""),
		ClientToken: util.PtrString(""),
		Billing:     Billing,
	}
	err = client.PurchaseReservedEipGroup(purchaseReservedEipGroupRequest)
	if err != nil {
