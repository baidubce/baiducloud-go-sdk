...
func UpdateBaseDdosThreshold() {
	...
	updateBaseDdosThresholdRequest := &eip.UpdateBaseDdosThresholdRequest{
		Ip:            util.PtrString(""),
	...
	err = client.UpdateBaseDdosThreshold(updateBaseDdosThresholdRequest)
	if err != nil {
