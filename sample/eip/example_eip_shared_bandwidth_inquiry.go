...
func SharedBandwidthInquiry() {
	...
	sharedBandwidthInquiryRequest := &eip.SharedBandwidthInquiryRequest{
		BandwidthInMbps: util.PtrInt32(int32(0)),
		Count:           util.PtrInt32(int32(0)),
		IpNum:           util.PtrInt32(int32(0)),
		Billing:         Billing,
	}
	result := &eip.SharedBandwidthInquiryResponse{}
	result, err = client.SharedBandwidthInquiry(sharedBandwidthInquiryRequest)
	if err != nil {
