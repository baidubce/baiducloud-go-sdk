...
func CreateAIGateway() {
	...
	createAIGatewayRequest := &aigw.CreateAIGatewayRequest{
	...
	result, err := client.CreateAIGateway(createAIGatewayRequest)
	if err != nil {
