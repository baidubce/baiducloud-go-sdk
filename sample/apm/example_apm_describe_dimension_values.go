...
func DescribeDimensionValues() {
	...
	describeDimensionValuesRequest := &apm.DescribeDimensionValuesRequest{
	...
	result, err := client.DescribeDimensionValues(describeDimensionValuesRequest)
	if err != nil {
