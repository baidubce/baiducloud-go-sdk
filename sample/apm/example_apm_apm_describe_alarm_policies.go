...
func ApmDescribeAlarmPolicies() {
	...
	apmDescribeAlarmPoliciesRequest := &apm.ApmDescribeAlarmPoliciesRequest{
	...
	result, err := client.ApmDescribeAlarmPolicies(apmDescribeAlarmPoliciesRequest)
	if err != nil {
