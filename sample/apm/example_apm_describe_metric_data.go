...
func DescribeMetricData() {
	...
	describeMetricDataRequest := &apm.DescribeMetricDataRequest{
		Action:                 util.PtrString(""),
		Metrics:                []*apm.MetricQuery{},
		MetricsName:            util.PtrString(""),
		MetricsCompareTo:       []*string{},
		MetricsFilters:         []*apm.Filter{},
	...
	result, err := client.DescribeMetricData(describeMetricDataRequest)
	if err != nil {
