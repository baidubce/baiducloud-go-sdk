...
func ApmCreateAlarmPolicy() {
	...
	apmCreateAlarmPolicyRequest := &apm.ApmCreateAlarmPolicyRequest{
		Name:                                 util.PtrString(""),
	...
	result, err := client.ApmCreateAlarmPolicy(apmCreateAlarmPolicyRequest)
	if err != nil {
