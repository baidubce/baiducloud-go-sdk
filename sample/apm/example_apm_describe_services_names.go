...
func DescribeServicesNames() {
	...
	describeServicesNamesRequest := &apm.DescribeServicesNamesRequest{
	...
	result, err := client.DescribeServicesNames(describeServicesNamesRequest)
	if err != nil {
