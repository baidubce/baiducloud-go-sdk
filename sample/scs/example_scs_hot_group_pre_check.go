...
func HotGroupPreCheck() {
	...
	hotGroupPreCheckRequest := &scs.HotGroupPreCheckRequest{
		Leader:    Leader,
		Followers: []*scs.FollowersItem{},
	}
	result, err := client.HotGroupPreCheck(hotGroupPreCheckRequest)
	if err != nil {
