...
func GetSystemParameterList() {
	...
	getSystemParameterListRequest := &scs.GetSystemParameterListRequest{
		Engine:        util.PtrString(""),
		EngineVersion: util.PtrString(""),
		ClusterType:   util.PtrString(""),
	}
	result, err := client.GetSystemParameterList(getSystemParameterListRequest)
	if err != nil {
