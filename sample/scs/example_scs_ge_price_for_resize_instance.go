...
func GePriceForResizeInstance() {
	...
	gePriceForResizeInstanceRequest := &scs.GePriceForResizeInstanceRequest{
	...
	result, err := client.GePriceForResizeInstance(gePriceForResizeInstanceRequest)
	if err != nil {
