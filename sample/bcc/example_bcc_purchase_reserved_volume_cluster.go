...
func PurchaseReservedVolumeCluster() {
	...
	purchaseReservedVolumeClusterRequest := &bcc.PurchaseReservedVolumeClusterRequest{
		ClusterId: util.PtrString(""),
		Billing:   Billing,
	}
	result, err := client.PurchaseReservedVolumeCluster(purchaseReservedVolumeClusterRequest)
	if err != nil {
