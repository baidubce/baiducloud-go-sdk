...
func DescribePlannedEventRecords() {
	...
	describePlannedEventRecordsRequest := &bcc.DescribePlannedEventRecordsRequest{
	...
	result, err := client.DescribePlannedEventRecords(describePlannedEventRecordsRequest)
	if err != nil {
