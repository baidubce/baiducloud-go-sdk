...
func PurchaseReservedVolume() {
	...
	purchaseReservedVolumeRequest := &bcc.PurchaseReservedVolumeRequest{
		VolumeId:   util.PtrString(""),
		Billing:    Billing,
		InstanceId: util.PtrString(""),
	}
	result, err := client.PurchaseReservedVolume(purchaseReservedVolumeRequest)
	if err != nil {
