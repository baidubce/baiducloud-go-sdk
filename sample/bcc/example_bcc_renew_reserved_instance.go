...
func RenewReservedInstance() {
	...
	renewReservedInstanceRequest := &bcc.RenewReservedInstanceRequest{
	...
	result, err := client.RenewReservedInstance(renewReservedInstanceRequest)
	if err != nil {
