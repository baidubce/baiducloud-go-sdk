...
func DescribePlannedEvents() {
	...
	describePlannedEventsRequest := &bcc.DescribePlannedEventsRequest{
	...
	result, err := client.DescribePlannedEvents(describePlannedEventsRequest)
	if err != nil {
