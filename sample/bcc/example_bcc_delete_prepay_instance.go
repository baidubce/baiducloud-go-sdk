...
func DeletePrepayInstance() {
	...
	deletePrepayInstanceRequest := &bcc.DeletePrepayInstanceRequest{
	...
	result, err := client.DeletePrepayInstance(deletePrepayInstanceRequest)
	if err != nil {
