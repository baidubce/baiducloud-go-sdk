...
func ReleaseMultipleInstanceByPost() {
	...
	releaseMultipleInstanceByPostRequest := &bcc.ReleaseMultipleInstanceByPostRequest{
		InstanceIds:           []*string{},
	...
	err = client.ReleaseMultipleInstanceByPost(releaseMultipleInstanceByPostRequest)
	if err != nil {
