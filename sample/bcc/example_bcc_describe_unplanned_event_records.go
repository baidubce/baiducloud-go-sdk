...
func DescribeUnplannedEventRecords() {
	...
	describeUnplannedEventRecordsRequest := &bcc.DescribeUnplannedEventRecordsRequest{
	...
	result, err := client.DescribeUnplannedEventRecords(describeUnplannedEventRecordsRequest)
	if err != nil {
