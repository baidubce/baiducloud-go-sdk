...
func GetReservedInstancePrice() {
	...
	getReservedInstancePriceRequest := &bcc.GetReservedInstancePriceRequest{
	...
	result, err := client.GetReservedInstancePrice(getReservedInstancePriceRequest)
	if err != nil {
