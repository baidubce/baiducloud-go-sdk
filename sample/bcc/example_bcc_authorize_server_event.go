...
func AuthorizeServerEvent() {
	...
	authorizeServerEventRequest := &bcc.AuthorizeServerEventRequest{
	...
	result, err := client.AuthorizeServerEvent(authorizeServerEventRequest)
	if err != nil {
