...
func GetDnsResolverRuleList() {
	...
	getDnsResolverRuleListRequest := &privatezone.GetDnsResolverRuleListRequest{
		Marker:  util.PtrString(""),
		MaxKeys: util.PtrString(""),
		Status:  util.PtrString(""),
	}
	result, err := client.GetDnsResolverRuleList(getDnsResolverRuleListRequest)
	if err != nil {
