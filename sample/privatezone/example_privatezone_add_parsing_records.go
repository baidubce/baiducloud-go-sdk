...
func AddParsingRecords() {
	...
	addParsingRecordsRequest := &privatezone.AddParsingRecordsRequest{
	...
	result := &privatezone.AddParsingRecordsResponse{}
	result, err = client.AddParsingRecords(addParsingRecordsRequest)
	if err != nil {
