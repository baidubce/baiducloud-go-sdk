...
func ListInstanceSyncRecords() {
	...
	listInstanceSyncRecordsRequest := &ccr.ListInstanceSyncRecordsRequest{
		InstanceId: util.PtrString(""),
		PolicyId:   util.PtrString(""),
		PageNo:     util.PtrInt32(int32(0)),
		PageSize:   util.PtrInt32(int32(0)),
	}
	result, err := client.ListInstanceSyncRecords(listInstanceSyncRecordsRequest)
	if err != nil {
