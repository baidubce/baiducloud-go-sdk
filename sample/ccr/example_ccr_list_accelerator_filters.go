...
func ListAcceleratorFilters() {
	...
	listAcceleratorFiltersRequest := &ccr.ListAcceleratorFiltersRequest{
		InstanceId: util.PtrString(""),
		PolicyName: util.PtrString(""),
		PageNo:     util.PtrInt32(int32(0)),
		PageSize:   util.PtrInt32(int32(0)),
	}
	result, err := client.ListAcceleratorFilters(listAcceleratorFiltersRequest)
	if err != nil {
