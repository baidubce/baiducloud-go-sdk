...
func ListImageMigrationRules() {
	...
	listImageMigrationRulesRequest := &ccr.ListImageMigrationRulesRequest{
		InstanceId: util.PtrString(""),
		PolicyName: util.PtrString(""),
		PageNo:     util.PtrInt32(int32(0)),
		PageSize:   util.PtrInt32(int32(0)),
	}
	result, err := client.ListImageMigrationRules(listImageMigrationRulesRequest)
	if err != nil {
