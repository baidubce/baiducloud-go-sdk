...
func CreateImageMigrationRule() {
	...
	createImageMigrationRuleRequest := &ccr.CreateImageMigrationRuleRequest{
	...
	err = client.CreateImageMigrationRule(createImageMigrationRuleRequest)
	if err != nil {
