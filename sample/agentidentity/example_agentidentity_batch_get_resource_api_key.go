...
func BatchGetResourceApiKey() {
	...
	batchGetResourceApiKeyRequest := &agentidentity.BatchGetResourceApiKeyRequest{
		XBceWorkloadAccessToken: util.PtrString(""),
		Names:                   []*string{},
		WorkloadAccessToken:     util.PtrString(""),
	}
	result, err := client.BatchGetResourceApiKey(batchGetResourceApiKeyRequest)
	if err != nil {
