...
func CompleteOauth2session() {
	...
	completeOauth2sessionRequest := &agentidentity.CompleteOauth2sessionRequest{
	...
	err = client.CompleteOauth2session(completeOauth2sessionRequest)
	if err != nil {
