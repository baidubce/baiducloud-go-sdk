...
func GetWorkloadAccessToken() {
	...
	getWorkloadAccessTokenRequest := &agentidentity.GetWorkloadAccessTokenRequest{
		BceUserId:       util.PtrString(""),
		AgentId:         util.PtrString(""),
		AgentName:       util.PtrString(""),
		DurationSeconds: util.PtrInt32(int32(0)),
	}
	result, err := client.GetWorkloadAccessToken(getWorkloadAccessTokenRequest)
	if err != nil {
