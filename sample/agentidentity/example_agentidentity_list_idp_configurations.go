...
func ListIdpConfigurations() {
	...
	listIdpConfigurationsRequest := &agentidentity.ListIdpConfigurationsRequest{
		UserPoolId: util.PtrString(""),
		Keyword:    util.PtrString(""),
		PageNo:     util.PtrInt32(int32(0)),
		PageSize:   util.PtrInt32(int32(0)),
	}
	result, err := client.ListIdpConfigurations(listIdpConfigurationsRequest)
	if err != nil {
