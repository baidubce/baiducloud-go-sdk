...
func GetIdpConfiguration() {
	...
	getIdpConfigurationRequest := &agentidentity.GetIdpConfigurationRequest{
		UserPoolId: util.PtrString(""),
		Id:         util.PtrString(""),
	}
	result, err := client.GetIdpConfiguration(getIdpConfigurationRequest)
	if err != nil {
