...
func GetMysqlSlowLogTemplate() {
	...
	getMysqlSlowLogTemplateRequest := &dbsc.GetMysqlSlowLogTemplateRequest{
	...
	result, err := client.GetMysqlSlowLogTemplate(getMysqlSlowLogTemplateRequest)
	if err != nil {
