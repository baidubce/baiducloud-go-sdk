...
func ListPostgresqlSlowLogs() {
	...
	listPostgresqlSlowLogsRequest := &dbsc.ListPostgresqlSlowLogsRequest{
	...
	result, err := client.ListPostgresqlSlowLogs(listPostgresqlSlowLogsRequest)
	if err != nil {
