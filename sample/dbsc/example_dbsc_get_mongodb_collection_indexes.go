...
func GetMongodbCollectionIndexes() {
	...
	getMongodbCollectionIndexesRequest := &dbsc.GetMongodbCollectionIndexesRequest{
	...
	err = client.GetMongodbCollectionIndexes(getMongodbCollectionIndexesRequest)
	if err != nil {
