...
func GetRedisSlowLogTemplate() {
	...
	getRedisSlowLogTemplateRequest := &dbsc.GetRedisSlowLogTemplateRequest{
	...
	result, err := client.GetRedisSlowLogTemplate(getRedisSlowLogTemplateRequest)
	if err != nil {
