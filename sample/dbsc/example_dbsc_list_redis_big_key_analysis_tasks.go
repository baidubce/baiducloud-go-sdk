...
func ListRedisBigKeyAnalysisTasks() {
	...
	listRedisBigKeyAnalysisTasksRequest := &dbsc.ListRedisBigKeyAnalysisTasksRequest{
	...
	result, err := client.ListRedisBigKeyAnalysisTasks(listRedisBigKeyAnalysisTasksRequest)
	if err != nil {
