...
func GetMongodbSlowLogTrend() {
	...
	getMongodbSlowLogTrendRequest := &dbsc.GetMongodbSlowLogTrendRequest{
	...
	result, err := client.GetMongodbSlowLogTrend(getMongodbSlowLogTrendRequest)
	if err != nil {
