...
func GetMongodbSlowQueryTemplate() {
	...
	getMongodbSlowQueryTemplateRequest := &dbsc.GetMongodbSlowQueryTemplateRequest{
	...
	result, err := client.GetMongodbSlowQueryTemplate(getMongodbSlowQueryTemplateRequest)
	if err != nil {
