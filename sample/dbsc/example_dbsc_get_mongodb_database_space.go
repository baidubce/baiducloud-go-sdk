...
func GetMongodbDatabaseSpace() {
	...
	getMongodbDatabaseSpaceRequest := &dbsc.GetMongodbDatabaseSpaceRequest{
	...
	result, err := client.GetMongodbDatabaseSpace(getMongodbDatabaseSpaceRequest)
	if err != nil {
