...
func GetMysqlDatabaseSpace() {
	...
	getMysqlDatabaseSpaceRequest := &dbsc.GetMysqlDatabaseSpaceRequest{
	...
	result, err := client.GetMysqlDatabaseSpace(getMysqlDatabaseSpaceRequest)
	if err != nil {
