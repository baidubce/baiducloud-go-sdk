...
func GetPostgresqlSlowLogTrend() {
	...
	getPostgresqlSlowLogTrendRequest := &dbsc.GetPostgresqlSlowLogTrendRequest{
	...
	result, err := client.GetPostgresqlSlowLogTrend(getPostgresqlSlowLogTrendRequest)
	if err != nil {
