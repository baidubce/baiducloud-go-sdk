...
func GetPegadbSlowLogTemplate() {
	...
	getPegadbSlowLogTemplateRequest := &dbsc.GetPegadbSlowLogTemplateRequest{
	...
	result, err := client.GetPegadbSlowLogTemplate(getPegadbSlowLogTemplateRequest)
	if err != nil {
