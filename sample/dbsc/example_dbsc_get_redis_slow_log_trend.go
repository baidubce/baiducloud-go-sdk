...
func GetRedisSlowLogTrend() {
	...
	getRedisSlowLogTrendRequest := &dbsc.GetRedisSlowLogTrendRequest{
	...
	result, err := client.GetRedisSlowLogTrend(getRedisSlowLogTrendRequest)
	if err != nil {
