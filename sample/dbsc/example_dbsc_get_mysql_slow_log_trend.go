...
func GetMysqlSlowLogTrend() {
	...
	getMysqlSlowLogTrendRequest := &dbsc.GetMysqlSlowLogTrendRequest{
	...
	result, err := client.GetMysqlSlowLogTrend(getMysqlSlowLogTrendRequest)
	if err != nil {
