...
func GetPegadbSlowLogTrend() {
	...
	getPegadbSlowLogTrendRequest := &dbsc.GetPegadbSlowLogTrendRequest{
	...
	result, err := client.GetPegadbSlowLogTrend(getPegadbSlowLogTrendRequest)
	if err != nil {
