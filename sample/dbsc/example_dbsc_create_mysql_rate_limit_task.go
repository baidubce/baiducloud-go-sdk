...
func CreateMysqlRateLimitTask() {
	...
	createMysqlRateLimitTaskRequest := &dbsc.CreateMysqlRateLimitTaskRequest{
	...
	err = client.CreateMysqlRateLimitTask(createMysqlRateLimitTaskRequest)
	if err != nil {
