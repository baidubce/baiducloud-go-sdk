...
func GetMongodbCollectionSpaceTrend() {
	...
	getMongodbCollectionSpaceTrendRequest := &dbsc.GetMongodbCollectionSpaceTrendRequest{
	...
	result, err := client.GetMongodbCollectionSpaceTrend(getMongodbCollectionSpaceTrendRequest)
	if err != nil {
