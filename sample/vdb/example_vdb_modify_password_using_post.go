...
func ModifyPasswordUsingPOST() {
	...
	modifyPasswordUsingPOSTRequest := &vdb.ModifyPasswordUsingPOSTRequest{
	...
	err = client.ModifyPasswordUsingPOST(modifyPasswordUsingPOSTRequest)
	if err != nil {
