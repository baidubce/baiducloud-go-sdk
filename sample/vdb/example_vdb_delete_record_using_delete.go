...
func DeleteRecordUsingDELETE() {
	...
	deleteRecordUsingDELETERequest := &vdb.DeleteRecordUsingDELETERequest{
		InstanceId: util.PtrString(""),
		EngineType: util.PtrString(""),
		BatchId:    util.PtrString(""),
		BackupId:   util.PtrString(""),
	}
	err = client.DeleteRecordUsingDELETE(deleteRecordUsingDELETERequest)
	if err != nil {
