...
func PicturebookImageDelete() {
	...
	picturebookImageDeleteRequest := &image.PicturebookImageDeleteRequest{
		Image:    util.PtrString(""),
		Url:      util.PtrString(""),
		ContSign: util.PtrString(""),
	}
	result, err := client.PicturebookImageDelete(picturebookImageDeleteRequest)
	if err != nil {
