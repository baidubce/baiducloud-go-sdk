...
func AiRetouchingQueryTask() {
	...
	aiRetouchingQueryTaskRequest := &image.AiRetouchingQueryTaskRequest{
		TaskId: util.PtrString(""),
	}
	result, err := client.AiRetouchingQueryTask(aiRetouchingQueryTaskRequest)
	if err != nil {
