...
func PicturebookImageSearch() {
	...
	picturebookImageSearchRequest := &image.PicturebookImageSearchRequest{
	...
	result, err := client.PicturebookImageSearch(picturebookImageSearchRequest)
	if err != nil {
