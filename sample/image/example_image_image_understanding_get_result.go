...
func ImageUnderstandingGetResult() {
	...
	imageUnderstandingGetResultRequest := &image.ImageUnderstandingGetResultRequest{
		TaskId: util.PtrString(""),
	}
	result, err := client.ImageUnderstandingGetResult(imageUnderstandingGetResultRequest)
	if err != nil {
