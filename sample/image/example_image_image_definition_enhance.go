...
func ImageDefinitionEnhance() {
	...
	imageDefinitionEnhanceRequest := &image.ImageDefinitionEnhanceRequest{
		Image: util.PtrString(""),
		Url:   util.PtrString(""),
	}
	result, err := client.ImageDefinitionEnhance(imageDefinitionEnhanceRequest)
	if err != nil {
