...
func PicturebookImageUpdate() {
	...
	picturebookImageUpdateRequest := &image.PicturebookImageUpdateRequest{
	...
	result, err := client.PicturebookImageUpdate(picturebookImageUpdateRequest)
	if err != nil {
