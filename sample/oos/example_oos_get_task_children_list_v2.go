...
func GetTaskChildrenListV2() {
	...
	getTaskChildrenListV2Request := &oos.GetTaskChildrenListV2Request{
	...
	result, err := client.GetTaskChildrenListV2(getTaskChildrenListV2Request)
	if err != nil {
