...
func RealEstateCertificate() {
	...
	realEstateCertificateRequest := &ocr.RealEstateCertificateRequest{
	...
	result, err := client.RealEstateCertificate(realEstateCertificateRequest)
	if err != nil {
