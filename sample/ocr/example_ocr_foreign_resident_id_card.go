...
func ForeignResidentIdCard() {
	...
	foreignResidentIdCardRequest := &ocr.ForeignResidentIdCardRequest{
		Image:      util.PtrString(""),
		Url:        util.PtrString(""),
		PdfFile:    util.PtrString(""),
		PdfFileNum: util.PtrInt32(int32(0)),
	}
	result, err := client.ForeignResidentIdCard(foreignResidentIdCardRequest)
	if err != nil {
