...
func VehicleRegistrationCertificate() {
	...
	vehicleRegistrationCertificateRequest := &ocr.VehicleRegistrationCertificateRequest{
		Image: util.PtrString(""),
		Url:   util.PtrString(""),
	}
	result, err := client.VehicleRegistrationCertificate(vehicleRegistrationCertificateRequest)
	if err != nil {
