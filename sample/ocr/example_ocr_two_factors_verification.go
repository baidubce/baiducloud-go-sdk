...
func TwoFactorsVerification() {
	...
	twoFactorsVerificationRequest := &ocr.TwoFactorsVerificationRequest{
		Company: util.PtrString(""),
		Regnum:  util.PtrString(""),
	}
	result, err := client.TwoFactorsVerification(twoFactorsVerificationRequest)
	if err != nil {
