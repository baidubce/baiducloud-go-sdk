...
func BusinesslicenseVerificationStandard() {
	...
	businesslicenseVerificationStandardRequest := &ocr.BusinesslicenseVerificationStandardRequest{
		Verifynum: util.PtrString(""),
	}
	result, err := client.BusinesslicenseVerificationStandard(businesslicenseVerificationStandardRequest)
	if err != nil {
