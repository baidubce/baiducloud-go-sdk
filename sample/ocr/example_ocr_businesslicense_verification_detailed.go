...
func BusinesslicenseVerificationDetailed() {
	...
	businesslicenseVerificationDetailedRequest := &ocr.BusinesslicenseVerificationDetailedRequest{
		Verifynum: util.PtrString(""),
	}
	result, err := client.BusinesslicenseVerificationDetailed(businesslicenseVerificationDetailedRequest)
	if err != nil {
