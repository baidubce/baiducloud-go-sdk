...
func MedicalReportDetection() {
	...
	medicalReportDetectionRequest := &ocr.MedicalReportDetectionRequest{
		Image:       util.PtrString(""),
		Url:         util.PtrString(""),
		Location:    util.PtrBool(false),
		Probability: util.PtrBool(false),
	}
	result, err := client.MedicalReportDetection(medicalReportDetectionRequest)
	if err != nil {
