...
func PaperCutEduVlmGetResult() {
	...
	paperCutEduVlmGetResultRequest := &ocr.PaperCutEduVlmGetResultRequest{
		TaskId: util.PtrString(""),
	}
	result, err := client.PaperCutEduVlmGetResult(paperCutEduVlmGetResultRequest)
	if err != nil {
