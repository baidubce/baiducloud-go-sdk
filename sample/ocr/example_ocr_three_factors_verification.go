...
func ThreeFactorsVerification() {
	...
	threeFactorsVerificationRequest := &ocr.ThreeFactorsVerificationRequest{
		Name:    util.PtrString(""),
		Company: util.PtrString(""),
		Regnum:  util.PtrString(""),
	}
	result, err := client.ThreeFactorsVerification(threeFactorsVerificationRequest)
	if err != nil {
