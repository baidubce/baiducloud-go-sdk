...
func PaperCutEduVlmCreateTask() {
	...
	paperCutEduVlmCreateTaskRequest := &ocr.PaperCutEduVlmCreateTaskRequest{
	...
	result, err := client.PaperCutEduVlmCreateTask(paperCutEduVlmCreateTaskRequest)
	if err != nil {
