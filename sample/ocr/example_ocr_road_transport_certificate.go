...
func RoadTransportCertificate() {
	...
	roadTransportCertificateRequest := &ocr.RoadTransportCertificateRequest{
		Image:      util.PtrString(""),
		Url:        util.PtrString(""),
		PdfFile:    util.PtrString(""),
		PdfFileNum: util.PtrInt32(int32(0)),
	}
	result, err := client.RoadTransportCertificate(roadTransportCertificateRequest)
	if err != nil {
