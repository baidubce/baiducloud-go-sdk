...
func HandwritingCompositionGetResult() {
	...
	handwritingCompositionGetResultRequest := &ocr.HandwritingCompositionGetResultRequest{
		TaskId: util.PtrString(""),
	}
	result, err := client.HandwritingCompositionGetResult(handwritingCompositionGetResultRequest)
	if err != nil {
