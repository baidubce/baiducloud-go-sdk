...
func VehicleRegCertificate() {
	...
	vehicleRegCertificateRequest := &ocr.VehicleRegCertificateRequest{
		Image: util.PtrString(""),
		Url:   util.PtrString(""),
	}
	result, err := client.VehicleRegCertificate(vehicleRegCertificateRequest)
	if err != nil {
