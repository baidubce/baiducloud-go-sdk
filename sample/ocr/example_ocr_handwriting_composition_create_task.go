...
func HandwritingCompositionCreateTask() {
	...
	handwritingCompositionCreateTaskRequest := &ocr.HandwritingCompositionCreateTaskRequest{
	...
	result, err := client.HandwritingCompositionCreateTask(handwritingCompositionCreateTaskRequest)
	if err != nil {
