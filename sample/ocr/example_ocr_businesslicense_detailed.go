...
func BusinesslicenseDetailed() {
	...
	businesslicenseDetailedRequest := &ocr.BusinesslicenseDetailedRequest{
		Verifynum: util.PtrString(""),
	}
	result, err := client.BusinesslicenseDetailed(businesslicenseDetailedRequest)
	if err != nil {
