...
func BusinesslicenseStandard() {
	...
	businesslicenseStandardRequest := &ocr.BusinesslicenseStandardRequest{
		Verifynum: util.PtrString(""),
	}
	result, err := client.BusinesslicenseStandard(businesslicenseStandardRequest)
	if err != nil {
