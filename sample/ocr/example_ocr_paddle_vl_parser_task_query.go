...
func PaddleVlParserTaskQuery() {
	...
	paddleVlParserTaskQueryRequest := &ocr.PaddleVlParserTaskQueryRequest{
		TaskId: util.PtrString(""),
	}
	result, err := client.PaddleVlParserTaskQuery(paddleVlParserTaskQueryRequest)
	if err != nil {
