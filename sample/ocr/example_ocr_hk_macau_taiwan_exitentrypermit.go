...
func HkMacauTaiwanExitentrypermit() {
	...
	hkMacauTaiwanExitentrypermitRequest := &ocr.HkMacauTaiwanExitentrypermitRequest{
	...
	result, err := client.HkMacauTaiwanExitentrypermit(hkMacauTaiwanExitentrypermitRequest)
	if err != nil {
